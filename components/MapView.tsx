...
const styles = StyleSheet.create({
  ...
  // Enhanced Google Maps style start marker (Green)
  startMarker: {
    alignItems: 'center',
  ...
  // Enhanced Google Maps style end marker (Red)
  endMarker: {
    alignItems: 'center',
    justifyContent: 'center',
  },
  ...
  // Enhanced Google Maps style waypoint marker (Blue)
  waypointMarker: {
    alignItems: 'center',
    justifyContent: 'center',
  },
  ...
  // Enhanced weather marker styling
  weatherMarker: {
    alignItems: 'center',
    justifyContent: 'center',
  },
